...
export const bad = (c: Context, error: string) => c.json({ success: false, error, data: undefined } as ApiResponse, 400);
export const notFound = (c: Context, error = 'not found') => c.json({ success: false, error, data: undefined } as ApiResponse, 404);
